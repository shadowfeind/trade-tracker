...
export const metadata: Metadata = {
  title: "Next.js Avatars | TradeTracker - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for TradeTracker - Next.js Tailwind CSS Admin Dashboard Template",
};
