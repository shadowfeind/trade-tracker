...
export const metadata: Metadata = {
  title: "Next.js Buttons | TradeTracker - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for TradeTracker - Next.js Tailwind CSS Admin Dashboard Template",
};
