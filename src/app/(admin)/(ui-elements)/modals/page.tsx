...
export const metadata: Metadata = {
  title: "Next.js Modals | TradeTracker - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for TradeTracker - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
